...
> = {
	acceptCommunityInvite?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationAcceptCommunityInviteArgs, "communityId">
	>;
	addUserToCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationAddUserToCommunityArgs, "communityId" | "userId">
	>;
	blockUserFromCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationBlockUserFromCommunityArgs, "communityId" | "userId">
	>;
	...
	>;
	declineCommunityInvite?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationDeclineCommunityInviteArgs, "communityId">
	>;
	deleteGoal?: Resolver<
		ResolversTypes["String"],
		ParentType,
	...
	>;
	editCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationEditCommunityArgs, "communityId" | "input">
	>;
	editGoal?: Resolver<
		ResolversTypes["String"],
		ParentType,
	...
	>;
	enterInCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationEnterInCommunityArgs, "communityId">
	>;
	inviteUserToCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationInviteUserToCommunityArgs, "communityId" | "userId">
	>;
	leaveCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationLeaveCommunityArgs, "communityId">
	>;
	makeUserAdminOfCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationMakeUserAdminOfCommunityArgs, "communityId" | "userId">
	>;
	publishGoal?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationPublishGoalArgs, "goalId">
	>;
	publishJournal?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationPublishJournalArgs, "journalId">
	>;
	removeUserFromCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationRemoveUserFromCommunityArgs, "communityId" | "userId">
	>;
	setGoal?: Resolver<
		ResolversTypes["String"],
		ParentType,
	...
	shareGoal?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationShareGoalArgs, "communityId" | "goalId">
	>;
	shareJournal?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationShareJournalArgs, "communityId" | "journalId">
	>;
	unBlockUserFromCommunity?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationUnBlockUserFromCommunityArgs, "communityId" | "userId">
	>;
	updateJournal?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateJournalArgs, "journalId">
	>;
};
...
> = {
	...
	>;
	getJournalsOfUser?: Resolver<
		Array<ResolversTypes["Journal"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetJournalsOfUserArgs, "userId">
	>;
	...
	>;
	getSingleJournal?: Resolver<
		ResolversTypes["Journal"],
		ParentType,
		ContextType,
		RequireFields<QueryGetSingleJournalArgs, "journalId">
	>;
	...
	searchCommunities?: Resolver<
		Array<ResolversTypes["Community"]>,
		ParentType,
		ContextType,
		RequireFields<QuerySearchCommunitiesArgs, "searchString">
	>;
...
export type UserWithLessDetailsResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["UserWithLessDetails"] = ResolversParentTypes["UserWithLessDetails"],
> = {
	banned?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
	firstName?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
